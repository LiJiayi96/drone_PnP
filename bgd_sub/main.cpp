...
////    destroyAllWindows();
////    return EXIT_SUCCESS;
//    processVideo("/home/lijiayi/newdisk/videofiles/Video00.avi");
//}
//void processVideo(char* videoFilename) {
...
int main(int argc, char* argv[])
{
    ...
    const vector<double> distCoeffs{0.03819613038058793, -0.06112508916119349, -5.515361356058103e-05, 0.003470678820019871, 0};
...
//    cout << pose.matrix << endl;
    ...
    while (true) {
        ...
        threshold(frame_masked, binImg,242,255,THRESH_BINARY);
...
//        imshow("bin",binImg);
        ...
        if(PENGZHANG)
        {
            ...
            Mat structElement = getStructuringElement(MORPH_ELLIPSE, Size(2 * structElementSize + 1, 2 * structElementSize + 1),
...
//            cout << pose.matrix << endl;
            ...
            myWindow.spinOnce(1, true);
            myfile<< tvec1[0] << "," << tvec1[1] <<"," << tvec1[2] <<"," << tvec1[0] <<"," << tvec1[1] <<"," << tvec1[2] <<","<<endl;
            cout << n << endl;
//            if (n==150)
//                std::getchar();
        }
